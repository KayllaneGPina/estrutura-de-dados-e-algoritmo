...
2 - Efetuar o cálculo da quantidade de litros de combustível gasto em uma viagem, utilizando um automóvel que faz 12 Km por litro. Para obter o cálculo, o usuário deve fornecer o tempo gasto na viagem e a velocidade média durante ela. 
...
#print(converter_temperatura(c))

def viagem(tempo, velocidade) :
...
resultado = viagem(tempo, velocidade)
print(resultado)